...
export const postSurveyConfig: PostSurveyConfig = {
  ...
  "blocks": [
    ...
    {
      "id": "open_qualitative",
      "title": "EHR 使用体验与 AI 赋能下的医疗变革",
      "items": [
        {
          "id": "post_qual_l1_ehr_pain_ai_substitution",
          "type": "text",
          "text": "L1 EHR（电子健康记录，Electronic Health Record）功能需求与 AI 替代潜力\n\n在您的日常工作中，EHR 系统在哪些方面最让您感到费力或低效？这些痛点中，您认为哪些是 AI 有潜力替代或协助的？哪些仍需医生本人完成？\n\n提示：您可以从文档填写、信息整合、界面遗漏、警报疲劳（即系统频繁推送提醒导致医生逐渐忽视警报的现象）、重复录入、功能缺失等方面考虑。"
        },
        {
          "id": "post_qual_l2_human_ai_boundary",
          "type": "text",
          "text": "L2 人机边界与主动权\n\n具备主动性的 AI 系统「Agentic AI」快速发展——即能够在无需明确指令的情况下自主感知临床环境、制定多步骤计划并执行任务的系统（如主动发现护理缺口、推送风险预警、协调跨系统工作流）。如果 Agentic AI 被引入医疗服务场景，您认为哪些任务可以交由其独立处理？哪些环节必须保留医生的最终决策权？您最担心的边界在哪里？\n\n提示：您可以从行政工作、风险预警、异常标记、诊断建议、用药决策、治疗介入、敏感沟通、责任承担等方面考虑。"
        },
        {
          "id": "post_qual_l3_system_transformation",
          "type": "text",
