...
export const postSurveyConfig: PostSurveyConfig = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "items": [
        {
          "id": "post_qual_ehr_redesign",
          "type": "text",
          "text": "如果未来可以重新设计 EHR，您最希望哪些工作从医生日常中消失？AI 又能帮医疗系统实现哪些现在做不到的能力？为什么？请说明原因。\n\n提示：如：减少重复文书、自动整理病史、整合不同系统信息、发现遗漏问题、预测随访需求、降低点击和查找负担等。"
        },
        {
          "id": "post_qual_ai_autonomy",
          "type": "text",
          "text": "如果未来 AI 能主动发现问题、整理信息、提出下一步建议，甚至推动部分流程继续进行，您愿意把哪些主动权交给它？哪些主动权绝对不能交给它？为什么？\n\n提示：如：风险提醒、草拟记录、整理患者信息、安排低风险流程；或诊断判断、治疗决策、修改医嘱、告知敏感信息、承担最终责任等。"
        },
        {
          "id": "post_qual_infrastructure_impact",
          "type": "text",
          "text": "如果 AI 不只是辅助工具，而是成为临床信息工作的基础设施，您认为医疗系统会被改造成什么样？它会如何影响医生能力、工作负担、责任边界和医院管理？您最期待什么，最担心什么？医院应提前建立哪些规则或新角色？\n\n提示：如：能力退化或能力重塑、额外核查 AI 的隐性工作、责任模糊、AI 审核岗位、质量监测、审计记录、问责机制、使用边界、组织监督和信任校准等。"
        }
      ]
    }
  ]
