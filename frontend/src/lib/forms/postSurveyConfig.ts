...
export const postSurveyConfig: PostSurveyConfig = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "items": [
        {
          "id": "post_qual_future_ai_roles",
          "type": "text",
          "text": "展望未来 3–5 年，您认为 AI 在临床文本处理和电子医疗系统中，最适合承担哪些角色或任务？哪些任务仍应主要由临床人员亲自完成？请结合具体场景说明您的理由。\n\n提示：例如患者消息处理、EHR 记录辅助、病历或随访内容总结、随访说明生成、低风险常规文书任务等。"
        },
        {
          "id": "post_qual_trust_conditions",
          "type": "text",
          "text": "为了让您愿意在真实工作中使用并信任这类 AI 工具，系统最需要具备哪些条件、功能或保障？相反，哪些问题会让您不愿意使用或降低信任？请说明原因。\n\n提示：例如信息来源依据、结果透明度、可解释性、审计记录、数据安全与隐私保护、责任边界、人工最终把关、错误纠正机制、培训与技术支持等。"
        },
        {
          "id": "post_qual_workflow_responsibility",
          "type": "text",
          "text": "如果这类 AI 工具在临床工作中被广泛使用，您认为它会如何改变临床工作流程、医生角色和责任分配？您认为相关责任应如何划分或共享？您最期待哪些变化，又最担心哪些风险？\n\n提示：例如效率提升、工作负担变化、过度依赖、临床写作能力变化、错误传播、医患沟通影响、长期治理与风险监测等。"
        }
      ]
    }
  ]
